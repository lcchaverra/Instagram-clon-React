        ...
        <div className="Modal-container">
            <div className="Modal">
                <div className="Modal-content-grid">
                  ...
                  <div className="Modal-content-item">
                    <div className="Modal-right-elements">
                    <div className="user-info">
                      <div className="user-info-start">
                        <img className="user-info-profile-pic" src={ProfilePic} alt="Foto de Perfil del Usuario" />
                        <span className="user-name">{userName? userName : 'RandomUser'}</span>
                      </div>
                      <span className="more-options">...</span>
                    </div>
                      <div className={`comments-section ${userData? '' : 'comments-section-without-comments' }`}>
                       {userData ? (
                          <div className="comment-element">
                            <div className="comment-pic">
                              <img src={ProfilePic} alt="Foto de perfil del usuario que hizo el comentario" />
                            </div>
                            <div className="comment-data-container">
                              <div className="comment-data">
                              <p className="comment-username">{userData.userName}</p>
                              <p>{userData.message}</p>
                              </div>
                              <div className="comment-time-response">
                                <span>Ahora</span>
                                <span>Responder</span>
                              </div>
                            </div>
                            ...
                            <>
                            <p className="without-comments-title">Todavia no hay comentarios.</p>
                            <span>Inicia la conversacion.</span>
                          </>    
                        )}
                      </div>
                      <div className="reactions-sections">
                        <div className="icons-sections">
                          ...
                          <svg aria-label="Emoji" className="x1lliihq x1n2onr6" color="rgb(245, 245, 245)" fill="rgb(245, 245, 245)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Emoji</title><path d="M15.83 10.997a1.167 1.167 0 1 0 1.167 1.167 1.167 1.167 0 0 0-1.167-1.167Zm-6.5 1.167a1.167 1.167 0 1 0-1.166 1.167 1.167 1.167 0 0 0 1.166-1.167Zm5.163 3.24a3.406 3.406 0 0 1-4.982.007 1 1 0 1 0-1.557 1.256 5.397 5.397 0 0 0 8.09 0 1 1 0 0 0-1.55-1.263ZM12 .503a11.5 11.5 0 1 0 11.5 11.5A11.513 11.513 0 0 0 12 .503Zm0 21a9.5 9.5 0 1 1 9.5-9.5 9.51 9.51 0 0 1-9.5 9.5Z"></path></svg>
                            <input ref={inputRef} className="comment-input" placeholder="Agrega un comentario..." type="text" />
                            <button className="comment-button" onClick={aggComment}>Publicar</button>
                          </div>
                      </div>
                    </div>
                  </div>
